...
def MDI(regressor, feature_names, folder_save, name_save):
    forest_importances = pd.Series(regressor.feature_importances_, index=feature_names)  
...
folder = "/home/pamela/Desktop/Codigos_paper/"
percentage = 0.5
...
folder_save = '/home/pamela/Desktop/Codigos_paper/'
...
regressor3 = xgb.XGBRegressor(max_depth=3, n_estimators=10, learning_rate=0.5)  #n_estimators=10, max_depth=10
